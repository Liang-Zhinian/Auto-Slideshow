...
{
    public sealed partial class LocalMainPage : Page
    {
        ...
        private async void addLink_Click(object sender, RoutedEventArgs e)
        {
            ...
            if (folder != null)
            {
                ...
                StorageApplicationPermissions.FutureAccessList.Add(folder); //.AddOrReplace("PickedFolderToken", folder);
                Link link = new Link();
                link.Url = folder.Path;
                LinkList.Add(link);
            }
        ...
        private void removeLink_Click(object sender, RoutedEventArgs e)
        {
            ...
            LinkList.Remove((AutoSlide.Views.Link)button.DataContext);
        ...
        private void generateSlideShow_Click(object sender, RoutedEventArgs e)
        {
            ...
            if(urls.Count != 0)
                this.Frame.Navigate(typeof(AutoSlide.Views.Slideshow), new object[] { "Local", urls });
            else
            {
